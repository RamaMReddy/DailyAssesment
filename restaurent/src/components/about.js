  ...
  return (
    ...
    <Box  paddingTop={40} sx={{backgroundColor:'orange', textAlign:'center',
     ...
     >
         ...
         <Typography> At Food Court, we believe in the power of great food and warm hospitality. Nestled in the heart of , our restaurant is a culinary oasis where passion and creativity come together to create unforgettable dining experiences.
